...
Dilated cardiomyopathy (DCM) is a heterogeneous condition affecting the structure and function of the heart that has a high morbidity and mortality rate. There are multiple aetiological factors involved in the development of DCM, from monogenic genetic causes to environmental exposures. Current genetic testing identifies a culprit gene in approximately 15-25% of sporadic cases and 20-40% of patients with familial DCM. However, the heritability of is XX estimated from common variants suggests that there exists an underlying propensity to the development of DCM, how this interacts with different exposures over the life course is not fully understood. 

In the clinic we are often faced with so called gene-elusive DCM, patients who display the phenotype but lack a known pathogenic variant. Polygenic risk scores can be used to determine the overall burden of DCM associated variants, identified from large genome-wide association studies. With knowledge of the baseline prevalence of DCM in the general population a polygenic risk score can be leveraged to estimate the population attributable risk for any particular individual.
...
Sequencing data for 2,XXX individuals referred for dilated cardiomyopathy were collection from XX centers: X, Y, X.
